...
from sentence_types import encode, encode_data, import_embedding
...
manual_comments = ["How are you doing?", "Where will we go today?", "The world is fantastic!", "Sometimes we see what we want to see.", "There are too many of them.", "Do your homework!", "To infinity and beyond.", "May there be peace on earth."]

manual_test =  encode(manual_comments)
manual_test = sequence.pad_sequences(manual_test, maxlen=maxlen)

predictions = model.predict(manual_test, batch_size=batch_size)
